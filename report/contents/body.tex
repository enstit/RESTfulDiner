...
\begin{frame}[allowframebreaks]{Data model implementation}
	...
	\lstinputlisting[language=PythonPlus,linerange={17-22,24-26,28-32,35-38}]{../app/models/department.py}
...
\begin{frame}[allowframebreaks,fragile]{API resources}
	...
	\begin{lstlisting}[caption={\texttt{GET /api/v1/departments} response}]
	"@context": {
